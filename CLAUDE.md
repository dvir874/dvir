...
### 🔴 Imagery — צניעות (Permanent Rule)

**כל אישה שמופיעה בתמונה במוצר — חייבת להיות לבושה בצניעות.** כתפיים מכוסות,
מחשוף גבוה, גב מכוסה, שמלה לא צמודה. זה חל במיוחד על כלות.

- **הדרישה נכתבת בתוך הפרומפט מראש** — בסעיף Brand או References. לא מתקנים
  אחרי, לא חותכים תמונה. רנדר לא צנוע → מייצרים מחדש.
- **לכתוב את זה גם כשלא ביקשנו דמות בכלל** — Stitch מוסיף אנשים למסכי חתונה
  מיוזמתו.
- חל על Stitch, על מודלי תמונה, ועל בחירת stock.

מעבר להעדפה של ה-CEO זו גם החלטה עסקית: נתח משמעותי משוק החתונות בישראל הוא
דתי ומסורתי, ומוקאפ לא צנוע פוסל את המוצר אצלם לפני שקראו מילה. DEC-011.
