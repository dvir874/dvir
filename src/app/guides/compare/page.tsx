...
export const metadata: Metadata = {
  title: "השוואת שירותי אישורי הגעה לחתונה 2026 — מה באמת חשוב לבדוק",
...
const ROWS: { label: string; sms: string; phone: string; us: string }[] = [
  ...
  /* המספרים האלה נמדדו ב-23/08/2026 ממחירונים מפורסמים — ראה
     ai-os/PRICING-RESEARCH.md. הטור האמצעי אמר "₪900–1,500", והמחיר האמיתי
     של שירות עם מוקד אנושי הוא 600–750₪ ל-300 מוזמנים. טווח מנופח בטבלה
     שכל תפקידה לבנות אמון פוגע באמינות של כל שורה אחרת בה, ומול הורים
     שבודקים שלוש הצעות זה מתגלה בשיחה אחת. */
  { label: "מחיר ל-300 מוזמנים",     sms: "₪200–350",       phone: "₪600–750",        us: "₪249 קבוע" },
  { label: "דשבורד לזוג בזמן אמת",   sms: "לרוב לא",        phone: "✗",               us: "✓ מלא" },
  { label: "סידורי הושבה דיגיטליים", sms: "בתוספת ₪100+",   phone: "בתוספת",          us: "₪100 כולל שליחת שולחנות" },
