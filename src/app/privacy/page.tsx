...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "מהשיחה בוואטסאפ: אורח שכותב לנו בוואטסאפ — כדי לאשר, לשנות מספר, לשאול או לבקש שנפסיק — ההודעה עצמה נשמרת אצלנו, יחד עם מועד המסירה והקריאה. זה מה שמאפשר לענות לו, לזהות שהוא ביקש להפסיק, ולוודא שההודעה בכלל הגיעה. תוכן ההודעות אינו מועבר לזוג, למעט מה שהאורח מסר במפורש כתשובה — כמה מגיעים, העדפת מנה, בקשה מיוחדת או ברכה.",
  ...
  },
  {
    ...
    body: [
      ...
      "וואטסאפ: 053-331-8177 · דוא״ל: dvir@regalifnei.com",
    ],
  },
];
