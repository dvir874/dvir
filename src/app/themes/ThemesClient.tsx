...
export default function ThemesClient({
  ...
  return (
    <div dir="rtl" lang="he" className="min-h-screen" style={{ background: "#F8F5EF" }}>
      ...
      {/* Grid */}
      <div className="max-w-5xl mx-auto px-4 pb-32 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {THEME_LIST.map((t) => {
      ...
      {/* Sticky bottom bar */}
      <div
        className="fixed bottom-0 left-0 right-0 px-4 py-4 flex flex-col sm:flex-row items-center justify-center gap-3"
        style={{
