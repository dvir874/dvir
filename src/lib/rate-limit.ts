 ...
 * request of a key sets resetAt = now + windowMs, and everything until that
 * moment counts against the same window. A true sliding window ages each
 ...
 * of the next — and the name now matches the code.
 *
