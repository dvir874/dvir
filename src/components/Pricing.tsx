...
const packages = [
  {
    name: "הזמנה דיגיטלית",
    tagline: "עיצוב אישי להזמנה דיגיטלית המותאמת לאופי האירוע שלכם.",
    highlight: false,
  ...
  {
    name: "הזמנה + דף אירוע",
    tagline: "הזמנה דיגיטלית לצד דף אירוע מעוצב עם כל פרטי האירוע במקום אחד.",
    highlight: false,
    badge: null as string | null,
    features: [
      "עיצוב הזמנה דיגיטלית אישית",
